...
<script>
    ...
    methods:{
        getData(){
           axios.get('/api/categories/show?lang_id='+this.lang_id+'&tag_id='+this.tag_id).then(res=>{
        ...
        getProducts(page,params={}){
            ...
            config.params=params;
             axios.get('/api/products?lang_id='+this.lang_id+'&tag_id='+this.tag_id+'&page='+page,config).then(res=>{
