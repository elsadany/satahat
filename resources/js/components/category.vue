<template>
    ...
    <section class="range-slider">
      ...
      <input :value="max_price" name="price_to"  :min="min_price" :max="max_price" step="5" type="range">
                    ...
                    <div class="col-lg-9 ">
                        <div class="row mx-0"  >
                            <div class="col-xl-3 col-lg-6 col-md-5 col-sm-6 col-10 mb-4  mb-4" v-for="(row,k) in products " :key="'row'+k">
                                <div class="g-card">
                                    <div class="card ">
                                        <div class="img-wrap">
...
<script>
    ...
    methods:{
        getData(){
           axios.get('/api/categories/get?lang_id='+this.lang_id+'&category_id='+this.category_id+'&tag_id='+this.tag_id).then(res=>{
        ...
        getProducts(page,params={}){
            ...
            config.params=params;
             axios.get('/api/products?lang_id='+this.lang_id+'&category_id='+this.category_id+'&page='+page,config).then(res=>{
